...
| Metric | Value |
|---|---|
| DEV01 mean CFO (all modulations) | +408.9 Hz |
| DEV02 mean CFO (all modulations) | -1108.1 Hz |
| CFO separation | 1517.0 Hz |
| DEV01 within-session CFO std | 21785.89 Hz |
| DEV02 within-session CFO std | 14407.47 Hz |

A 1517 Hz separation with sub-Hz within-device variance provides a physically grounded,  
